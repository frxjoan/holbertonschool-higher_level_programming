...
Defines a Rectangle class with validation, area/perimeter computation,
string representations, instance counting, customizable print symbol,
area comparison, and square creation.
"""
...
class Rectangle:
    ...
    def __repr__(self):
        ...
        recreate the instance with eval().
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Returns:
            Rectangle: Rectangle with the larger area (rect_1 if equal).
        """
    ...
    def square(cls, size=0):
        ...
        Returns:
            Rectangle: New square Rectangle instance.
        """
